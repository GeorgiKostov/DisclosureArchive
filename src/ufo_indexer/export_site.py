  ...
  <script>
    ...
    function selectGlobeLocation(index) {
      ...
      if (location) {
        ...
        performSearch();
        window.setTimeout(() => {
          const card = document.getElementById(`doc-${location.doc_id}`);
